...
class SendMail
{
    public function send($title, $content, $nTo, $mTo, $diachicc ='')
    {
        ...
        try {
            ...
            $mail->Username = 'nguyenconghau230503@gmail.com';                 // SMTP username
            $mail->Password = 'hqsf dqpt hrmz npkv';                           // SMTP password
            ...
            //Recipients
            $mail->setFrom('nguyenconghau230503@gmail.com', 'Forgot Password');
