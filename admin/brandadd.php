...
<?php
    $brand = new brand();
    // Kiểm tra nếu đang có yêu cầu gửi đi là phương thức POST
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // Lấy dữ liệu từ biến POST và gán vào $brandName
        $brandName = $_POST['brandName'];   
        // Thực hiện thêm thương hiệu mới và gán kết quả vào biến $insertBrand
        ...
        <main>
            ...
            <div class="activity-grid">
                <div class="activity-card">
                    ...
                    <?php
                        // Hiển thị thông báo sau khi thêm thương hiệu mới (nếu có)
