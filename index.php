...
<body>
	<section class="app">
		...
		<div class="app_body">
				...
				<div class="grid wide">
					<div class="ds-layout">
						<h2 class="section-font">
							...
							<span class="light-shadow">NỔI BẬt</span>
						</h2>
						<div class="row">
							<div class="ds-flex-container">
								<div class="ds-flex-item-image col l-5">
									<img id="ds-flex-img-1" src="./assets/img/mau3.jpg" alt="fashion model">

									<div class="ds-flex-item-text">
										<span class="small-up-caps">Hồ Ngọc Hà</span>
										<h3 class="medium-style">Hồ Ngọc Hà là một người mẫu nữ được đại diện bởi WePro Entertainment</h3>
									</div>
								</div>

								<div class="ds-flex-item-image col l-7">
									<img id="ds-flex-img-2" src="./assets/img/hnh1.webp">
								</div>
							</div>
						</div>
			...
			<div class="grid wide">
				<h2 class="app_view-shop_tile">Tin mới hôm nay</h2>
					...
					<div class="row">
						<div class="example-2 col l-4">
							<div class="wrapper">
								...
								<div class="data">
									<div class="content">
										<span class="author">Hoddie</span>
										<h1 class="title"><a href="#">Stranger Things: Âm thanh từ Thế giới Ngược Đãi</a></h1>
										<p class="text">Những người yêu thích xem liên tục trên Netflix sẽ háo hức chờ đợi việc phát hành kỹ thuật số của bản nhạc nền Survive, ra mắt hôm nay.</p>
							...
							<div class="wrapper1">
								...
								<div class="data">
									<div class="content">
										<span class="author">Hoddie</span>
										<h1 class="title"><a href="#">Stranger Things: Âm thanh từ Thế giới Ngược Đãi</a></h1>
										<p class="text">Các người yêu thích xem liên tục trên Netflix sẽ rất mong đợi việc phát hành kỹ thuật số của bản nhạc nền Survive, ra mắt hôm nay.</p>
										<a href="#" class="button">Đọc thêm</a>
									</div>
								</div>
							</div>
