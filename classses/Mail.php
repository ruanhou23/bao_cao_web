...
class Mail
{
    ...
    public function sendMail($data)
    {
        ...
        if ($Email == "") {
            ...
            // Tạo một đối tượng SendMail
            $sendMailObject = new SendMail();
            // Gọi phương thức send() thông qua đối tượng vừa tạo
            $sendMai = $sendMailObject->send($title, $content, $account['name'], $account['email']);
            if ($sendMai) {
