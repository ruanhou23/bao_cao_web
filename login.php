                ...
                <div class="app_content-all">
                    ...
                    <div class="row">
                        <div class="fix-content col c-5">
                            <div class="auth__form">
                                <div class="auth__form-container">
                                    <div class="form-container-title">Bạn đã có tài khoản shop
                                        <p>
                                    ...
                                    <div class="baoloi">
                                    <?php
                                    // Hiển thị thông báo lỗi đăng nhập (nếu có) từ biến $login_user
                                        if (isset($login_user)) {
                                            echo $login_user;
                                        }
                                    ?>
                        ...
                        <div class="col c-5">
                            <div class="auth__form">
                                <div class="auth__form-container">
                                    <div class="form-container-title">Khách hàng mới của Shop
                                        <p>                              
                                            Nếu bạn chưa có tài khoản trên shop.com, hãy sử dụng tùy chọn này để truy cập biểu mẫu đăng ký.
